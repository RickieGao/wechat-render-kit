# Design Brief — fresh 家族（Claude Design 输入 B）

> 复制以下整段到 Claude Design **项目 B**。**不要**上传作者旧文章截图——本家族要彻底重设。
...
- **`fresh-humanist`** —— 配色温暖有机，装饰倾向有机 / 书页感，留白多、节奏慢，标题字体可用衬线
- **`fresh-tech`** —— 配色克制理性，装饰倾向几何 / 线性，信息密度高、节奏紧凑，标题字体倾向无衬线
